...
//
//func (m mockWeightRepo) CreateWeightEntry(w request.Weight) error {
//	return nil
//}
//
//func (m mockWeightRepo) GetUser(userID int) (request.User, error) {
//	if userID != 1 {
//		return request.User{}, errors.New("storage - user doesn't exists")
//	}
//
//	return request.User{
//		ID:            userID,
...
//	tests := []struct {
//		name    string
//		request request.NewWeightRequest
//		want    error
//	}{
//		{
